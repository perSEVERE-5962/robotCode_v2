...
public class AlignToTag extends Command {
  ...
  // consider not stopping the robot when hastarget becomes false, allowing the
  // robot to align using gyro.
  ...
  public void execute() {
    ...
    double rotSpeed = rotationPID.calculate(currentPose.getRotation().getRadians(),
