...
public class AbsoluteDriveAdv extends Command {
   ...
   * current heading after being multiplied by a constant. The look booleans are shortcuts to get
   * the robot to face a certain direction. Based off of ideas in
