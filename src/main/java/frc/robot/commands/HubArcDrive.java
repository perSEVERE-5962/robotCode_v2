...
public class HubArcDrive extends Command {
  ...
  // added compensation for robot velocity, discussed in
  // https://www.chiefdelphi.com/t/a-note-on-optimal-driving-for-shoot-on-the-move/512979/11
  public HubArcDrive(
  ...
  public void execute() {
    ...
    double shooterVelocity =
        (shooter.getMotorVelocity() / 60.0) * (2.0 * Math.PI * Units.inchesToMeters(2.0));
    ...
    headingSpeed =
        MathUtil.clamp(
            headingSpeed,
            -maxHeadingSpeed * 0.5,
            maxHeadingSpeed * 0.5); // clamp speeds for controlled turning
