...
public class SystemHealthTelemetry implements SubsystemTelemetry {
    ...
    public int getLoopOverrunCount() { return loopOverrunCount; }

    public double getVoltageSlope() { return voltageSlope; }
    public int getBrownoutRiskLevel() { return brownoutRiskLevel; }
    public boolean isBrownoutRisk() { return brownoutRisk; }
    public double getTotalCurrentAmps() { return totalCurrentAmps; }
    public double getPeakCurrentAmps() { return peakCurrentAmps; }
}
