...
public class CycleTracker {
  ...
  public void log() {
    ...
    SafeLog.put(
        "Cycle/Stats/SuccessRate",
        completedCycles + failedCycles > 0
            ? (double) completedCycles / (completedCycles + failedCycles) * 100
            : 0);

    SafeLog.put(
        "Cycle/Stats/AvgTotalMs", completedCycles > 0 ? totalCycleTimeMs / completedCycles : 0);
    SafeLog.put(
        "Cycle/Stats/AvgIntakeMs", completedCycles > 0 ? totalIntakeTimeMs / completedCycles : 0);
    SafeLog.put("Cycle/Stats/AvgAimMs", completedCycles > 0 ? totalAimTimeMs / completedCycles : 0);
    SafeLog.put("Cycle/Stats/BestMs", bestCycleTimeMs == Double.MAX_VALUE ? 0 : bestCycleTimeMs);
  ...
  public double getLastTotalCycleTimeMs() {
    return lastTotalCycleTimeMs;
  }
}
