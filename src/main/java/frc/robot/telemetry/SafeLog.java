...
/**
 * Per-signal crash isolation for Logger.recordOutput() calls.
 * One failure never affects other signals or crashes the robot.
 */
public final class SafeLog {
    ...
    // =========================================================================
    // WPILib geometry types (AdvantageKit supports these directly)
    // =========================================================================
