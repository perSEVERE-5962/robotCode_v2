...
public class ShooterTelemetry implements SubsystemTelemetry {
  ...
  public void update() {
    ...
    // Active command tracking: which command currently owns the shooter subsystem
    try {
    ...
    // Compute explicit state string from existing booleans
