...
public class Vision {
  ...
  /**
   * Check if vision is locked on target (stable tracking for ReadyToShoot).
   * Requires consecutive frames with targets to confirm lock.
   */
  ...
  /**
   * Update target lock tracking and log vision telemetry.
   * Call this in periodic or after updatePoseEstimation.
   */
