...
public class SysId {
  ...
  public static Command agitatorSysIdCommand() {
    ...
    SysIdRoutine routine = new SysIdRoutine(
      ...
      new Mechanism((Voltage voltage) -> inst.getMotor().setVoltage(voltage), (SysIdRoutineLog log) -> {
        log.motor("agitator").voltage(Volts.of(inst.getMotor().getBusVoltage())).linearPosition(Meters.of(inst.getPosition())).linearVelocity(MetersPerSecond.of(inst.getMotorVelocity()));
      }, inst));
  ...
  public static Command hangerSysIdCommand() {
    ...
    SysIdRoutine routine = new SysIdRoutine(
      new Config(),
      new Mechanism((Voltage voltage) -> inst.getMotor().setVoltage(voltage), (SysIdRoutineLog log) -> {
        log.motor("hanger").voltage(Volts.of(inst.getMotor().getBusVoltage())).linearPosition(Meters.of(inst.getPosition())).linearVelocity(MetersPerSecond.of(inst.getMotorVelocity()));
      }, inst));
    return routine.quasistatic(Direction.kForward).andThen(Commands.waitSeconds(delay))
        .andThen(routine.quasistatic(Direction.kReverse)).andThen(Commands.waitSeconds(delay))
        .andThen(routine.dynamic(Direction.kForward)).andThen(Commands.waitSeconds(delay))
  ...
  public static Command indexerSysIdCommand() {
    ...
    SysIdRoutine routine = new SysIdRoutine(
      new Config(),
      new Mechanism((Voltage voltage) -> inst.getMotor().setVoltage(voltage), (SysIdRoutineLog log) -> {
        log.motor("indexer").voltage(Volts.of(inst.getMotor().getBusVoltage())).linearPosition(Meters.of(inst.getPosition())).linearVelocity(MetersPerSecond.of(inst.getMotorVelocity()));
      }, inst));
    return routine.quasistatic(Direction.kForward).andThen(Commands.waitSeconds(delay))
        .andThen(routine.quasistatic(Direction.kReverse)).andThen(Commands.waitSeconds(delay))
        .andThen(routine.dynamic(Direction.kForward)).andThen(Commands.waitSeconds(delay))
  ...
  public static Command intakePivotSysIdCommand() {
    ...
    SysIdRoutine routine = new SysIdRoutine(
      new Config(),
      new Mechanism((Voltage voltage) -> inst.getMotor().setVoltage(voltage), (SysIdRoutineLog log) -> {
        log.motor("intakePivot").voltage(Volts.of(inst.getMotor().getBusVoltage())).linearPosition(Meters.of(inst.getPosition())).linearVelocity(MetersPerSecond.of(inst.getMotorVelocity()));
      }, inst));
    return routine.quasistatic(Direction.kForward).andThen(Commands.waitSeconds(delay))
        .andThen(routine.quasistatic(Direction.kReverse)).andThen(Commands.waitSeconds(delay))
        .andThen(routine.dynamic(Direction.kForward)).andThen(Commands.waitSeconds(delay))
  ...
  public static Command shooterSysIdCommand() {
    ...
    SysIdRoutine routine = new SysIdRoutine(
      new Config(),
      new Mechanism((Voltage voltage) -> inst.getMotor().setVoltage(voltage), (SysIdRoutineLog log) -> {
        log.motor("shooter").voltage(Volts.of(inst.getMotor().getBusVoltage())).linearPosition(Meters.of(inst.getPosition())).linearVelocity(MetersPerSecond.of(inst.getMotorVelocity()));
      }, inst));
    return routine.quasistatic(Direction.kForward).andThen(Commands.waitSeconds(delay))
        .andThen(routine.quasistatic(Direction.kReverse)).andThen(Commands.waitSeconds(delay))
        .andThen(routine.dynamic(Direction.kForward)).andThen(Commands.waitSeconds(delay))
